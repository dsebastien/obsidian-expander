...
If you prefer not to use the environment variable, manually copy these files to `<YourVault>/.obsidian/plugins/expander/`:
...
- Check that files exist in `<vault>/.obsidian/plugins/expander/`
- Restart Obsidian
