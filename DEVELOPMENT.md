...
```bash
git clone https://github.com/dsebastien/obsidian-expander.git
cd obsidian-expander
```
...
If you prefer not to use the environment variable, manually copy these files to `<YourVault>/.obsidian/plugins/obsidian-expander/`:
...
- Check that files exist in `<vault>/.obsidian/plugins/obsidian-expander/`
- Restart Obsidian
